...
t.test_estargz(cfg, cfg.IMAGE_NAME, temp, r, False)
c.reset_latency_bandwidth(cfg)
...
c.set_latency_bandwidth(cfg, 200)
t.test_starlight(cfg, cfg.IMAGE_NAME, temp, r, cfg.OLD_IMAGE_NAME, False, 0)
c.reset_latency_bandwidth(cfg)
...
c.set_latency_bandwidth(cfg, 200)
t.test_vanilla(cfg, cfg.IMAGE_NAME, temp, r, False)
c.reset_latency_bandwidth(cfg)
c.reset_container_service()
